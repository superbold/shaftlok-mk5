<template>
  <div class="quote-form-fields">
    ...
    <div class="form-section">
      <h3 class="form-section-label">Vessel</h3>
      <div class="form-row">
        <div class="form-group">
    ...
    <div class="form-section">
      <h3 class="form-section-label">Propeller</h3>
    ...
    <div class="form-section">
      <h3 class="form-section-label">Engine &amp; Transmission</h3>
      <div class="form-row">
        <div class="form-group">
    ...
    <div class="form-section">
      <h3 class="form-section-label">Locking System</h3>
