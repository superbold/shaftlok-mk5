export const TERMS_AND_CONDITIONS = [
  'Cancellation of this order will cost the client the 50% payment.',
  'The design of this unit can only be disclosed to others with explicit written consent from the current owner, Sean Nigel.',
  ...
  'Neither party shall be liable for any delay or failure in performance caused by acts of God, war, or other events beyond its reasonable control.'
] as const
